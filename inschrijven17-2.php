<?php /* Template Name: Inschrijfpagina 2 sessies VVLOENERMARK */ ?>
<!doctype html>
<html>
<head><?php wp_head(); ?>
	<meta charset="utf-8">
...
<div class="info">
    ...
    <p>Eerste sessie: <span class="groen"> <?php the_field('tijd'); ?></span></p>
<?php if( get_field('deelname') ): ?>
    <p>DEELNAME: <span class="groen"> <?php the_field('deelname'); ?></span></p>
<?php endif; ?>
    <p>Tweede sessie: <span class="groen"> <?php the_field('tijd2'); ?></span></p>
<?php if( get_field('deelname') ): ?>
    <p>DEELNAME: <span class="groen"> <?php the_field('deelname2'); ?></span></p>
<?php endif; ?>
</div>
<div class="inschrijven">
    <a href="<?php the_field('formulier'); ?>"><div class="btn btn-default inschrijfknop" style="margin-bottom: 5px;">Eerste sessie</div></a>
    <a href="<?php the_field('formulier2'); ?>"><div class="btn btn-default inschrijfknop">Tweede sessie</div></a>
